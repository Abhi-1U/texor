...
convert_to_markdown<-function(article_dir){
    ...
    rmarkdown::pandoc_convert(input_file,to= "markdown",options=c("-s",'--lua-filter',bib_filter,'--lua-filter',code_block_filter),output = md_file,citeproc = TRUE,verbose = TRUE)
}
